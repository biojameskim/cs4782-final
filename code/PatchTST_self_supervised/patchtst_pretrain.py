...
parser.add_argument('--mask_ratio', type=float, default=None, help='masking ratio for the input (if None, random between 0.2 and 0.6)')
# Optimization args
parser.add_argument('--n_epochs_pretrain', type=int, default=2, help='number of pre-training epochs')
