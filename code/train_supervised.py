...
import torchmetrics
from datasetsTST import Dataset_Custom, Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Pred
from patchTST_1dconv import PatchTST_4782
...
class patchTST(pl.LightningModule):
    def __init__(self, seq_len, num_channels, embed_dim, heads, depth, target_seq_size, patch_len=8, dropout=0.0, lr=1e-4, embed_strat="patch", decay=0.9,
                 ema=False, residual=False, embed_mode='linear', use_4782=False):
        super().__init__()
